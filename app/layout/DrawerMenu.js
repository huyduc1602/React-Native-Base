        ...
        <>
            <View style={{ flex: 1, backgroundColor: colors.card }}>
                ...
                >
                    ...
                    <View>
                        <Text style={{ ...FONTS.h6, color: COLORS.white, lineHeight: 20 }}>LMQ</Text>
                        <Text style={{ ...FONTS.font, color: COLORS.white }}>quylm@vn.ids.jp</Text>
                    </View>
                </View>
                ...
                <View style={{ paddingBottom: 30, paddingHorizontal: 15, paddingTop: 20 }}>
                    <Text style={{ ...FONTS.h6, color: colors.title }}>RNReduxSagaBaseTS</Text>
